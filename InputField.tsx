...
export default function InputField({ label, hint, className, height = "default", ...props }: Partial<InputFieldProps> & InputHTMLAttributes<HTMLInputElement>) {
	...
	const labelStyles = "text-gray-600 dark:text-gray-400 font-roboto font-normal text-sm px-1 absolute top-[20px] left-2 -translate-y-1/2 py-0.5 peer-focus:top-0.5 peer-focus:text-primary peer-focus:text-xs peer-focus:px-2 peer-placeholder-shown:text-xs peer-placeholder-shown:px-2 peer-placeholder-shown:top-0.5 z-[1] transition-all peer-focus:bg-gray-100 dark:peer-focus:bg-gray-900 peer-placeholder-shown:bg-gray-100 dark:peer-placeholder-shown:bg-gray-900 peer-placeholder-shown:dark:bg-gray-900 group-[.hascontents]:bg-gray-100 dark:group-[.hascontents]:bg-gray-900 group-[.hascontents]:text-xs group-[.hascontents]:px-2 group-[.hascontents]:top-0.5 group-[.hascontents]:peer-invalid:!text-error";
