...
export default function InputField({ label, hint, className, height = "default", ...props }: Partial<InputFieldProps> & InputHTMLAttributes<HTMLInputElement>) {
	...
	const input = "peer w-full h-full text-gray-700 dark:text-gray-200 font-roboto font-normal disabled:border-dashed transition-colors placeholder-shown:border placeholder-shown:border-gray-500/20 border text-sm px-3 py-2.5 focus:px-[11px] focus:!border-2 rounded-lg border-gray-400/40 dark:border-gray-400/25 focus:!border-primary backdrop-blur-2xl !bg-white/10 dark:!bg-gray-800/10 group-[.hascontents]:invalid:!border-error";
	const labelStyles = "text-gray-600 dark:text-gray-400 font-roboto font-normal text-sm px-1 absolute top-[20px] left-2 -translate-y-1/2 py-0.5 peer-focus:top-0.5 peer-focus:text-primary peer-focus:text-xs peer-focus:px-2 peer-placeholder-shown:text-xs peer-placeholder-shown:px-2 peer-placeholder-shown:top-0.5 z-[1] transition-all peer-focus:bg-gray-200 dark:peer-focus:bg-gray-800 peer-placeholder-shown:bg-gray-200 dark:peer-placeholder-shown:bg-gray-800 peer-placeholder-shown:dark:bg-gray-800 group-[.hascontents]:bg-gray-200 dark:group-[.hascontents]:bg-gray-800 group-[.hascontents]:text-xs group-[.hascontents]:px-2 group-[.hascontents]:top-0.5 group-[.hascontents]:peer-invalid:!text-error";
