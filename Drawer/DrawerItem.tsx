...
export default function DrawerItem({ children, icon: Icon, active, waves = true, ...props }: Partial<DrawerItemProps> & HTMLAttributes<HTMLLIElement>) {
	...
	const base = "flex p-4 gap-2 h-14 items-center rounded-full group transition-colors duration-75";
	...
	return (
		<li className={ classNames(base, active ? primary : gray) }
			ref={ ref }
			{ ...props }>
