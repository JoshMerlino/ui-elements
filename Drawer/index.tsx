...
export default function Drawer({ children, className, scrim, close, ...props }: Partial<{ scrim: boolean, close: () => void }> & HTMLAttributes<HTMLDivElement>): JSX.Element {
	return (
		<>
			<aside className={ classNames("bg-white dark:bg-gray-800 ease-in-out w-[300px] h-full z-[10] shadow-md transition-[opacity] flex flex-col p-2 py-4 rounded-r-2xl overflow-y-auto", className) }
